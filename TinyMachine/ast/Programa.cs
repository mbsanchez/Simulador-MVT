...
namespace TinyMachine.ast
{
    class Programa
    {
        private Dictionary<int, Operacion> instrucciones;

        public Dictionary<int, Operacion> Instrucciones { get { return instrucciones; } }

        public Programa()
        {
            this.instrucciones = new Dictionary<int, Operacion>();
        }
     }
}
