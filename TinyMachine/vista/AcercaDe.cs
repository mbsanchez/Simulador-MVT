...
namespace TinyMachine
{
    public partial class AcercaDe : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/mbsanchez/Simulador-MVT");
        }

        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("http://www.seclab.tuwien.ac.at/projects/cuplex/");
        }

        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("http://www.cs.sjsu.edu/~louden/cmptext/");
        }
    }
}
